...
{
	public class AllJewelryController : Controller
	{
		public IActionResult Index()
		{
			GetProducts gp = new GetProducts();
			Uri uri = new Uri("https://localhost:44365/api/Products/getbycategory?categoryId=12");
			var viewModel = gp.GetProductsByCategory(uri);
			return View(viewModel);


			#region Withoud Method
			//HttpClient client = new HttpClient();
			//HttpResponseMessage msg = null;
			//string jsonContent = string.Empty;


			//client.BaseAddress = new Uri("https://localhost:44365/api/Products/getbycategory?categoryId=12");
