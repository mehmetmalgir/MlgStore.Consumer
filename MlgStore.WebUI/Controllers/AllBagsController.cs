...
{
	public class AllBagsController : Controller
	{
		public IActionResult Index()
		{
			GetProducts gp = new GetProducts();
            Uri uri = new Uri("https://localhost:44365/api/Products/getbycategory?categoryId=13");
            ...
            //client.BaseAddress = new Uri("https://localhost:44365/api/Products/getbycategory?categoryId=13");
