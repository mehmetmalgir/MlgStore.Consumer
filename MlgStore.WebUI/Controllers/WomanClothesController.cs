...
namespace MlgStore.WebUI.Controllers
{
	public class WomanClothesController : Controller
	{
		public IActionResult Index()
		{
			...
			var viewModel = gp.GetWomanProductsByCategory(1);
			...
			//	viewModel.Products = JsonConvert.DeserializeObject<List<ApiProductDto>>(jsonContent).Where(x => x.CategoryID == 1).ToList();
