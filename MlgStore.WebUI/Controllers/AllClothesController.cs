...
namespace MlgStore.WebUI.Controllers
{
	public class AllClothesController : Controller
	{
		public IActionResult Index()
        {
            ...
            Uri uri = new Uri("https://localhost:44365/api/Products/getbycategory?categoryId=1");
			...
			//client.BaseAddress = new Uri("https://localhost:44365/api/Products/getbycategory?categoryId=1");
