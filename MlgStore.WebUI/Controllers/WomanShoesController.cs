...
{
	public class WomanShoesController : Controller
	{
		public IActionResult Index()
		{
            GetProducts gp = new GetProducts();
            var viewModel = gp.GetWomanProductsByCategory(2);
            ...
            //	viewModel.Products = JsonConvert.DeserializeObject<List<ApiProductDto>>(jsonContent).Where(x => x.CategoryID == 2).ToList();
